...
<div class="col-md-8 col-md-offset-2" style = "margin-top:100px;">
    <table class="table table-striped table-bordered table-hover datatable">
        ...
        <tr>
            ...
            <th>Country Name</th>
            <th style="display:none;">Country_code</th>
            <th style="display:none">Publication Status</th>
            <th style="display:none">Status</th>
            <th style="display:none">Hello</th>
        ...
        while($row = $students->fetch_assoc()):?>
            ...
            <tr>
                ...
                <td style="display:none;"><?php echo $row['country_code']; ?></td>
                <td style="display:none"></td>
                <td style="display:none">></td>
                <td  style="display:none" class="text-right">

                </td><td  style="display:none" class="text-right">
